...
payment_methods = ["COD", "Prepaid Card", "Prepaid UPI", "Wallet"]
...
discount_pct = np.clip(rng.normal(22, 15, N), 8, 75)
...
num_previous_returns = np.round(base_return_rate * num_previous_orders).clip(
    0, num_previous_orders
)
